...
class _FitnessLevelSelectionScreenState
  ...
  static const List<FitnessLevelOption> _fitnessLevelOptions = [
    FitnessLevelOption(
      value: 'Beginner',
      title: 'Beginner',
      description: 'I am just getting started with fitness training.',
    ),
    FitnessLevelOption(
      value: 'Intermediate',
      title: 'Intermediate',
      description: 'I have some training experience and routine.',
    ),
    FitnessLevelOption(
      value: 'Advanced',
      title: 'Advanced',
      description: 'I train consistently and can handle higher intensity.',
    ),
    FitnessLevelOption(
      value: 'Professional',
      title: 'Professional',
      description: 'I am highly trained and perform at elite level.',
    ),
  ];
  ...
  void _handleBack() {
    ...
    Get.offAllNamed(AppRoutes.goalSelection);
  }
            ...
            children: [
              Positioned.fill(
                child: Align(
                  ...
                  child: Image.asset(
                    'assets/images/fitnesslevelbg.png',
  ...
  Widget _buildLevelCard({
    required FitnessLevelOption level,
