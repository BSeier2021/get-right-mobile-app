...
class _ExerciseFrequencySelectionScreenState
  ...
  static const List<ExercisePlanOption> _exerciseFrequencyOptions = [
    ExercisePlanOption(
      value: 'Daily',
      title: 'Daily',
      description: 'I plan to exercise every day.',
    ),
    ExercisePlanOption(
      value: 'Weekly',
      title: 'Weekly',
      description: 'I follow a general weekly exercise routine.',
    ),
    ExercisePlanOption(
      value: 'TwiceaWeek',
      title: 'Twice a Week',
      description: 'I can commit to two sessions per week.',
    ),
    ExercisePlanOption(
      value: 'ThreeTimesaWeek',
      title: 'Three Times a Week',
      description: 'I can commit to three sessions per week.',
    ),
    ExercisePlanOption(
      value: 'FourTimesaWeek',
      title: 'Four Times a Week',
      description: 'I can commit to four sessions per week.',
    ),
    ExercisePlanOption(
      value: 'FiveTimesaWeek',
      title: 'Five Times a Week',
      description: 'I can commit to five sessions per week.',
    ),
    ExercisePlanOption(
      value: 'SixTimesaWeek',
      title: 'Six Times a Week',
      description: 'I can commit to six sessions per week.',
    ),
  ];
  ...
  void _handleBack() {
    ...
    Get.offAllNamed(AppRoutes.fitnessLevelSelection);
  }
  ...
  Future<void> _getStarted(AuthController auth) async {
    ...
    Get.offAllNamed(
      ...
      arguments: {
        ...prev,
        'exercisePlan': value,
        if (plan != null) 'exercisePlanTitle': plan.title,
      },
    );
  }
            ...
            children: [
              Positioned.fill(
                child: Align(
                  ...
                  child: Image.asset(
                    'assets/images/planexercisebg.png',
  ...
  Widget _buildPlanCard({
    required ExercisePlanOption plan,
